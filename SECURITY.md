...
minimal public issue without sensitive details and ask the maintainers for a
private reporting channel.

The Railway watchtower is intentionally watch-only. A deployment that receives
spending keys is outside this project's security model.
